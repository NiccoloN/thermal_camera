...
{
    const auto context = mlx90640_detail::buildToContext(frameData, params, emissivity, vdd, ta, tr);
    mlx90640_detail::calculateTo(frameData, params, context, result);
}
...
{
    const auto context = mlx90640_detail::buildToContext(frameData, params, emissivity, vdd, ta, tr);
    mlx90640_detail::calculateToShort(frameData, params, context, result);
}
...
{
    return mlx90640_detail::getVdd(frameData, params);
}
...
{
    return mlx90640_detail::getTa(frameData, params, vdd);
}
